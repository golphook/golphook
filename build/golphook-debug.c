	...
	#define V_COMMIT_HASH "5815ab8"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "5815ab8"
#endif
...
typedef struct golphook__App golphook__App;
...
// added by module `golphook.utils`
...
#include "windows.h"
#else
#error VERROR_MESSAGE Header file "windows.h", needed for module `golphook.utils` was not found. Please install the corresponding development headers.
#endif
...
#include "windows.h"
#else
#error VERROR_MESSAGE Header file "windows.h", needed for module `golphook` was not found. Please install the corresponding development headers.
#endif
...
#include "windows.h"
#else
#error VERROR_MESSAGE Header file "windows.h", needed for module `main` was not found. Please install the corresponding development headers.
#endif
...
struct golphook__App {
	voidptr h_mod;
	v__vmod__Manifest v_mod;
	FILE* file;
};
...
typedef struct thread_arg_main__spawn {
	voidptr arg1;
} thread_arg_main__spawn;
u32 main__spawn_thread_wrapper(thread_arg_main__spawn *arg);
...
string strings__find_between_pair_byte(string input, byte start, byte end);
...
#define _const_strconv__parser_invalid_number 5
...
void _write_buf_to_fd(int fd, byte* buf, int buf_len);
...
int __stdcall unhandled_exception_handler(ExceptionPointers* e);
...
VV_LOCAL_SYMBOL int compare_8613322521397010905_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
Option_byte string_at_with_check(string s, int idx);
...
void golphook__utils__load_unload_console(bool _v_switch, FILE* andFile);
...
VV_LOCAL_SYMBOL int compare_13753401522076972052_string(string* a, string* b) {
...
Array_string os__init_os_args_wide(int argc, byte** argv);
...
os__FN_NTSuspendResume os__ntdll_fn(char* name);
...
void v__vmod__Scanner_tokenize(v__vmod__Scanner* s, v__vmod__TokenKind t_type, string val);
void v__vmod__Scanner_skip_whitespace(v__vmod__Scanner* s);
bool v__vmod__is_name_alpha(byte chr);
string v__vmod__Scanner_create_string(v__vmod__Scanner* s, byte q);
string v__vmod__Scanner_create_ident(v__vmod__Scanner* s);
bool v__vmod__Scanner_peek_char(v__vmod__Scanner s, byte c);
void v__vmod__Scanner_scan_all(v__vmod__Scanner* s);
Option_multi_return_Array_string_int v__vmod__get_array_content(Array_v__vmod__Token tokens, int st_idx);
Option_v__vmod__Manifest v__vmod__Parser_parse(v__vmod__Parser* p);
...
void golphook__App_bootstrap(golphook__App* a, voidptr withModuleHandle);
void golphook__App_release(golphook__App* a);
voidptr golphook__init_app_singleton(void);
void main__spawn(voidptr h_mod);
bool __stdcall main__dll_main(voidptr h_mod, u32 reason, voidptr res);
VV_EXPORTED_SYMBOL bool __stdcall DllMain(voidptr h_mod, u32 reason, voidptr res); // exported fn main.dll_main
...
// ^^^ number of types for interface IError: 6
...
struct _IError_interface_methods IError_name_table[6] = {
	{
...
static int v_typeof_interface_idx_IError(int sidx) { /* IError */
	...
	if (sidx == _IError_os__ExecutableNotFoundError_index) return 65686;
	return 29;
}
...
inline byte strings__Builder_byte_at(strings__Builder* b, int n) {
	return (*(byte*)/*ee elem_sym */array_get(*(((Array_byte*)(b))), n));
}
...
string strings__Builder_cut_last(strings__Builder* b, int n) {
	int cut_pos = b->len - n;
	Array_byte _t1;
		Array_byte x = (_t1 = (*((Array_byte*)(b))), array_slice(_t1, cut_pos, _t1.len));
...
string strings__Builder_last_n(strings__Builder* b, int n) {
	...
	Array_byte _t2;
		Array_byte x = (_t2 = (*((Array_byte*)(b))), array_slice(_t2, b->len - n, _t2.len));
...
string strings__Builder_after(strings__Builder* b, int n) {
	...
	Array_byte _t2;
		Array_byte x = (_t2 = (*((Array_byte*)(b))), array_slice(_t2, n, _t2.len));
	return Array_byte_bytestr(x);
}
...
void strings__Builder_ensure_cap(strings__Builder* b, int n) {
	...
	byte* new_data = vcalloc(n * b->element_size);
	if (b->data != ((voidptr)(0))) {
...
int math__bits__trailing_zeros_8(byte x) {
	int _t1 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__ntz_8_tab, x))));
	return _t1;
}
...
int math__bits__trailing_zeros_16(u16 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn32tab, ((u32)((x & -x))) * _const_math__bits__de_bruijn32 >> (32 - 5)))));
	return _t2;
}
...
int math__bits__trailing_zeros_32(u32 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn32tab, ((x & -x)) * _const_math__bits__de_bruijn32 >> (32 - 5)))));
	return _t2;
}
...
int math__bits__trailing_zeros_64(u64 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn64tab, ((x & -x)) * _const_math__bits__de_bruijn64 >> (64 - 6)))));
	return _t2;
}

int math__bits__ones_count_8(byte x) {
	int _t1 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__pop_8_tab, x))));
	return _t1;
}

int math__bits__ones_count_16(u16 x) {
	int _t1 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__pop_8_tab, x >> 8U)) + (*(byte*)/*ee elem_sym */array_get(_const_math__bits__pop_8_tab, (x & ((u16)(0xffU)))))));
	return _t1;
}

int math__bits__ones_count_32(u32 x) {
	int _t1 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__pop_8_tab, x >> 24U)) + (*(byte*)/*ee elem_sym */array_get(_const_math__bits__pop_8_tab, (x >> 16U & 0xffU))) + (*(byte*)/*ee elem_sym */array_get(_const_math__bits__pop_8_tab, (x >> 8U & 0xffU))) + (*(byte*)/*ee elem_sym */array_get(_const_math__bits__pop_8_tab, (x & ((u32)(0xffU)))))));
	return _t1;
}
...
inline byte math__bits__reverse_8(byte x) {
	byte _t1 = (*(byte*)/*ee elem_sym */array_get(_const_math__bits__rev_8_tab, x));
	return _t1;
}

// Attr: [inline]
inline u16 math__bits__reverse_16(u16 x) {
	u16 _t1 = (((u16)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__rev_8_tab, x >> 8U)))) | (((u16)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__rev_8_tab, (x & ((u16)(0xffU))))))) << 8U));
	return _t1;
}
...
int math__bits__len_8(byte x) {
	int _t1 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__len_8_tab, x))));
	return _t1;
}
...
int math__bits__len_16(u16 x) {
	...
	int _t1 = n + ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__len_8_tab, y))));
	return _t1;
}
...
multi_return_u32_u32 math__bits__div_32(u32 hi, u32 lo, u32 y) {
	if (y != 0U && y <= hi) {
		panic_debug(408, tos3("C:/v/vlib/math/bits/bits.v"), tos3("math.bits"), tos3("div_32"),  _const_math__bits__overflow_error);
		VUNREACHABLE();
	}
...
multi_return_u64_u64 math__bits__div_64(u64 hi, u64 lo, u64 y1) {
	u64 y = y1;
	if (y == 0U) {
		panic_debug(423, tos3("C:/v/vlib/math/bits/bits.v"), tos3("math.bits"), tos3("div_64"),  _const_math__bits__overflow_error);
		VUNREACHABLE();
	}
	if (y <= hi) {
		panic_debug(426, tos3("C:/v/vlib/math/bits/bits.v"), tos3("math.bits"), tos3("div_64"),  _const_math__bits__overflow_error);
		VUNREACHABLE();
	}
...
multi_return_int_strconv__PrepNumber strconv__parser(string s) {
	...
	if (i == 0 && s.len > 0) {
		return (multi_return_int_strconv__PrepNumber){.arg0=_const_strconv__parser_invalid_number, .arg1=pn};
	}
...
u64 strconv__converter(strconv__PrepNumber* pn) {
	...
	for (;;) {
		...
		multi_return_u32_u32_u32 mr_5788 = strconv__lsl96(s2, s1, s0);
		q2 = mr_5788.arg0;
		q1 = mr_5788.arg1;
		q0 = mr_5788.arg2;
		multi_return_u32_u32_u32 mr_5834 = strconv__lsl96(q2, q1, q0);
		r2 = mr_5834.arg0;
		r1 = mr_5834.arg1;
		r0 = mr_5834.arg2;
		multi_return_u32_u32_u32 mr_5890 = strconv__lsl96(r2, r1, r0);
		s2 = mr_5890.arg0;
		s1 = mr_5890.arg1;
		s0 = mr_5890.arg2;
		multi_return_u32_u32_u32 mr_5946 = strconv__add96(s2, s1, s0, q2, q1, q0);
		s2 = mr_5946.arg0;
		s1 = mr_5946.arg1;
		s0 = mr_5946.arg2;
		pn->exponent--;
		for (;;) {
			...
			multi_return_u32_u32_u32 mr_6069 = strconv__lsr96(s2, s1, s0);
			q2 = mr_6069.arg0;
			q1 = mr_6069.arg1;
			q0 = mr_6069.arg2;
			binexp++;
	...
	for (;;) {
		...
		for (;;) {
			...
			multi_return_u32_u32_u32 mr_6216 = strconv__lsl96(s2, s1, s0);
			q2 = mr_6216.arg0;
			q1 = mr_6216.arg1;
			q0 = mr_6216.arg2;
			binexp--;
	...
	if (s2 != 0U || s1 != 0U || s0 != 0U) {
		for (;;) {
			if (!(((s2 & mask28)) == 0U)) break;
			multi_return_u32_u32_u32 mr_6951 = strconv__lsl96(s2, s1, s0);
			q2 = mr_6951.arg0;
			q1 = mr_6951.arg1;
			q0 = mr_6951.arg2;
			binexp--;
	...
	if (((s1 & check_round_bit)) != 0U) {
		if (((s1 & ~check_round_mask)) != 0U) {
			multi_return_u32_u32_u32 mr_8033 = strconv__add96(s2, s1, s0, 0U, check_round_bit, 0U);
			s2 = mr_8033.arg0;
			s1 = mr_8033.arg1;
			s0 = mr_8033.arg2;
		} else {
			if (((s1 & (check_round_bit << ((u32)(1U))))) != 0U) {
				multi_return_u32_u32_u32 mr_8225 = strconv__add96(s2, s1, s0, 0U, check_round_bit, 0U);
				s2 = mr_8225.arg0;
				s1 = mr_8225.arg1;
				s0 = mr_8225.arg2;
			}
		...
		if ((s2 & (mask28 << ((u32)(1U)))) != 0U) {
			multi_return_u32_u32_u32 mr_8429 = strconv__lsr96(s2, s1, s0);
			q2 = mr_8429.arg0;
			q1 = mr_8429.arg1;
			q0 = mr_8429.arg2;
			binexp--;
...
Option_f64 strconv__atof64(string s) {
	...
	multi_return_int_strconv__PrepNumber mr_9540 = strconv__parser(s);
	res_parsing = mr_9540.arg0;
	pn = mr_9540.arg1;
...
string strconv__format_int(i64 n, int radix) {
	{ // Unsafe block
		if (radix < 2 || radix > 36) {
			panic_debug(11, tos3("C:/v/vlib/strconv/number_to_base.c.v"), tos3("strconv"), tos3("format_int"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("invalid radix: "), 0xfe07, {.d_i32 = radix}}, {_SLIT(" . It should be => 2 and <= 36"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
		if (n == 0) {
			return _SLIT("0");
...
string strconv__format_uint(u64 n, int radix) {
	{ // Unsafe block
		if (radix < 2 || radix > 36) {
			panic_debug(48, tos3("C:/v/vlib/strconv/number_to_base.c.v"), tos3("strconv"), tos3("format_uint"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("invalid radix: "), 0xfe07, {.d_i32 = radix}}, {_SLIT(" . It should be => 2 and <= 36"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
		if (n == 0U) {
			return _SLIT("0");
...
string strconv__fxx_to_str_l_parse_no_dot(string s) {
	...
	if (r_i > 1 && (*(byte*)/*ee elem_sym */array_get(res, r_i - 1)) == '.') {
		r_i--;
	}
	array_set(&res, r_i, &(byte[]) { 0 });
	return tos(res.data, r_i);
...
strings__Builder res;
	...
	for (;;) {
		...
		if (ch == 'c' && status == strconv__Char_parse_state__field_char) {
			...
			byte d1 = *(((byte*)((*(voidptr*)/*ee elem_sym */array_get(pt, p_index)))));
		...
		if (status == strconv__Char_parse_state__check_type) {
			if (ch == 'l') {
				...
				if (ch1 == ('h')) {
					if (ch2 == 'h') {
						d1 = ((u64)(*(((byte*)((*(voidptr*)/*ee elem_sym */array_get(pt, p_index)))))));
					} else {
	...
	if (p_index != pt.len) {
		panic_debug(532, tos3("C:/v/vlib/strconv/vprintf.c.v"), tos3("strconv"), tos3("v_sprintf"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe07, {.d_i32 = p_index}}, {_SLIT(" % conversion specifiers, but given "), 0xfe07, {.d_i32 = pt.len}}, {_SLIT(" args"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
...
inline void strconv__v_sprintf_panic(int idx, int len) {
	if (idx >= len) {
		panic_debug(541, tos3("C:/v/vlib/strconv/vprintf.c.v"), tos3("strconv"), tos3("v_sprintf_panic"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe07, {.d_i32 = idx + 1}}, {_SLIT(" % conversion specifiers, but given only "), 0xfe07, {.d_i32 = len}}, {_SLIT(" args"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
}
...
void array_ensure_cap(array* a, int required) {
	...
	byte* new_data = _v_malloc(new_size);
	if (a->data != ((voidptr)(0))) {
...
array array_repeat_to_depth(array a, int count, int depth) {
	if (count < 0) {
		panic_debug(158, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("repeat_to_depth"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("array.repeat: count is negative: "), 0xfe07, {.d_i32 = count}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
...
void array_insert(array* a, int i, voidptr val) {
	...
	{
		if (i < 0 || i > a->len) {
			panic_debug(204, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("insert"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.insert: index out of range (i == "), 0xfe07, {.d_i32 = i}}, {_SLIT(", a.len == "), 0xfe07, {.d_i32 = a->len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_insert_many(array* a, int i, voidptr val, int size) {
	...
	{
		if (i < 0 || i > a->len) {
			panic_debug(223, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("insert_many"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.insert_many: index out of range (i == "), 0xfe07, {.d_i32 = i}}, {_SLIT(", a.len == "), 0xfe07, {.d_i32 = a->len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_delete_many(array* a, int i, int size) {
	#if !defined(CUSTOM_DEFINE_no_bounds_checking)
	{
		if (i < 0 || i + size > a->len) {
			...
			panic_debug(283, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("delete_many"),   str_intp(4, _MOV((StrIntpData[]){{_SLIT("array.delete: index out of range (i == "), 0xfe07, {.d_i32 = i}}, {_SLIT0, 0xfe10, {.d_s = endidx}}, {_SLIT(", a.len == "), 0xfe07, {.d_i32 = a->len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr array_get(array a, int i) {
	...
	{
		if (i < 0 || i >= a.len) {
			panic_debug(334, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("get"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.get: index out of range (i == "), 0xfe07, {.d_i32 = i}}, {_SLIT(", a.len == "), 0xfe07, {.d_i32 = a.len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr array_first(array a) {
	...
	{
		if (a.len == 0) {
			panic_debug(359, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("first"),  _SLIT("array.first: array is empty"));
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr array_last(array a) {
	...
	{
		if (a.len == 0) {
			panic_debug(370, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("last"),  _SLIT("array.last: array is empty"));
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr array_pop(array* a) {
	...
	{
		if (a->len == 0) {
			panic_debug(397, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("pop"),  _SLIT("array.pop: array is empty"));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_delete_last(array* a) {
	...
	{
		if (a->len == 0) {
			panic_debug(415, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("delete_last"),  _SLIT("array.pop: array is empty"));
			VUNREACHABLE();
		}
	}
	#endif
...
array array_slice(array a, int start, int _end) {
	...
	{
		if (start > end) {
			panic_debug(434, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.slice: invalid slice index ("), 0xfe07, {.d_i32 = start}}, {_SLIT(" > "), 0xfe07, {.d_i32 = end}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
		if (end > a.len) {
			panic_debug(437, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.slice: slice bounds out of range ("), 0xfe07, {.d_i32 = end}}, {_SLIT(" >= "), 0xfe07, {.d_i32 = a.len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
		if (start < 0) {
			panic_debug(440, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("array.slice: slice bounds out of range ("), 0xfe07, {.d_i32 = start}}, {_SLIT(" < 0)"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_set(array* a, int i, voidptr val) {
	...
	{
		if (i < 0 || i >= a->len) {
			panic_debug(567, tos3("C:/v/vlib/builtin/array.v"), tos3("builtin"), tos3("set"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("array.set: index out of range (i == "), 0xfe07, {.d_i32 = i}}, {_SLIT(", a.len == "), 0xfe07, {.d_i32 = a->len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
string Array_byte_hex(Array_byte b) {
	byte* hex = malloc_noscan(b.len * 2 + 1);
	int dst_i = 0;
...
int copy(Array_byte* dst, Array_byte src) {
	...
	if (min > 0) {
		vmemmove(((byte*)(dst->data)), src.data, min);
	}
	return min;
}
...
VNORETURN void panic_optional_not_set(string s) {
	panic_debug(69, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_optional_not_set"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("optional not set ("), 0xfe10, {.d_s = s}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
	VUNREACHABLE();
	while(1);
}
...
VNORETURN void panic_error_number(string basestr, int errnum) {
	panic_debug(126, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_error_number"),  string__plus(basestr, c_error_number_str(errnum)));
	VUNREACHABLE();
	while(1);
}
...
byte* _v_malloc(int n) {
	if (n <= 0) {
		panic_debug(272, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc("), 0xfe07, {.d_i32 = n}}, {_SLIT(" <= 0)"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	byte* res = ((byte*)(0));
	...
	#endif
	if (res == 0) {
		panic_debug(302, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc("), 0xfe07, {.d_i32 = n}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return res;
}
...
byte* malloc_noscan(int n) {
	if (n <= 0) {
		panic_debug(315, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc_noscan"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc_noscan("), 0xfe07, {.d_i32 = n}}, {_SLIT(" <= 0)"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	byte* res = ((byte*)(0));
	#if defined(_VPREALLOC)
	...
	#endif
	if (res == 0) {
		panic_debug(349, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("malloc_noscan"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("malloc_noscan("), 0xfe07, {.d_i32 = n}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return res;
}
...
byte* v_realloc(byte* b, int n) {
	...
	#endif
	if (new_ptr == 0) {
		panic_debug(381, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("v_realloc"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("realloc("), 0xfe07, {.d_i32 = n}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return new_ptr;
}
...
byte* realloc_data(byte* old_data, int old_size, int new_size) {
	...
	#endif
	if (nptr == 0) {
		panic_debug(427, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("realloc_data"),   str_intp(4, _MOV((StrIntpData[]){{_SLIT("realloc_data("), 0xfe11, {.d_p = (void*)(old_data)}}, {_SLIT(", "), 0xfe07, {.d_i32 = old_size}}, {_SLIT(", "), 0xfe07, {.d_i32 = new_size}}, {_SLIT(") failed"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return nptr;
}
...
byte* vcalloc(int n) {
	if (n < 0) {
		panic_debug(437, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("vcalloc"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("calloc("), 0xfe07, {.d_i32 = n}}, {_SLIT(" < 0)"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	} else if (n == 0) {
		return ((byte*)(0));
	}
...
inline int v_fixed_index(int i, int len) {
	#if !defined(CUSTOM_DEFINE_no_bounds_checking)
	{
		if (i < 0 || i >= len) {
			...
			panic_debug(531, tos3("C:/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("v_fixed_index"),  s);
			VUNREACHABLE();
		}
	}
	#endif
...
voidptr __as_cast(voidptr obj, int obj_type, int expected_type) {
	if (obj_type != expected_type) {
		...
		panic_debug(39, tos3("C:/v/vlib/builtin/builtin.v"), tos3("builtin"), tos3("__as_cast"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("as cast: cannot cast `"), 0xfe10, {.d_s = obj_name}}, {_SLIT("` to `"), 0xfe10, {.d_s = expected_name}}, {_SLIT("`"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	return obj;
}
...
bool print_backtrace_skipping_top_frames_msvc(int skipframes) {
bool print_backtrace_skipping_top_frames_msvc_defer_0 = false;
voidptr handle;
	#if defined(_MSC_VER)
	{
		u64 offset = ((u64)(0U));
		Array_fixed_voidptr_100 backtraces = {0};
		SymbolInfoContainer *sic = HEAP(SymbolInfoContainer, ((SymbolInfoContainer){.syminfo = (SymbolInfo){.f_size_of_struct = 0,.f_type_index = 0,.f_index = 0,.f_size = 0,.f_mod_base = 0,.f_flags = 0,.f_value = 0,.f_address = 0,.f_register = 0,.f_scope = 0,.f_tag = 0,.f_name_len = 0,.f_max_name_len = 0,.f_name = 0,},.f_name_rest = {0},}));
		SymbolInfo* si = &(*(sic)).syminfo;
		si->f_size_of_struct = sizeof(SymbolInfo);
		si->f_max_name_len = sizeof(SymbolInfoContainer) - sizeof(SymbolInfo) - 1U;
		char* fname = ((char*)(&si->f_name));
		Line64 sline64 = (Line64){.f_size_of_struct = 0,.f_key = 0,.f_line_number = 0,.f_file_name = ((byte*)(0)),.f_address = 0,};
		sline64.f_size_of_struct = sizeof(Line64);
		handle = GetCurrentProcess();
		print_backtrace_skipping_top_frames_msvc_defer_0 = true;
		SymSetOptions(((_const_symopt_debug | _const_symopt_load_lines) | _const_symopt_undname));
		int syminitok = SymInitialize(handle, 0, 1);
		if (syminitok != 1) {
			eprintln(_SLIT("Failed getting process: Aborting backtrace.\n"));
			bool _t1 = false;
			// Defer begin
			if (print_backtrace_skipping_top_frames_msvc_defer_0) {
				#if defined(_MSC_VER)
					SymCleanup(handle);
		...
		int frames = ((int)(CaptureStackBackTrace(skipframes + 1, 100U, &backtraces[0], 0)));
		if (frames < 2) {
			eprintln(_SLIT("C.CaptureStackBackTrace returned less than 2 frames"));
			bool _t2 = false;
			// Defer begin
			if (print_backtrace_skipping_top_frames_msvc_defer_0) {
				#if defined(_MSC_VER)
		...
		for (int i = 0; i < frames; ++i) {
			...
			if (SymFromAddr(handle, (*(frame_addr)), &offset, si) == 1) {
				...
				if (SymGetLineFromAddr64(handle, (*(frame_addr)), &offset, &sline64) == 1) {
					...
					lineinfo =  str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = file_name}}, {_SLIT(":"), 0xfe06, {.d_u32 = lnumber}}, {_SLIT0, 0, { .d_c = 0 }}}));
				} else {
					addr: {}
					lineinfo =  str_intp(2, _MOV((StrIntpData[]){{_SLIT("?? : address = 0x"), 0x7000fe11, {.d_p = (void*)((&(*(frame_addr))))}}, {_SLIT0, 0, { .d_c = 0 }}}));
				}
				string sfunc = tos3(fname);
				eprintln( str_intp(4, _MOV((StrIntpData[]){{_SLIT0, 0x4fe07, {.d_i32 = nframe}}, {_SLIT(": "), 0x32fe10, {.d_s = sfunc}}, {_SLIT("  "), 0xfe10, {.d_s = lineinfo}}, {_SLIT0, 0, { .d_c = 0 }}})));
			} else {
				int cerr = ((int)(GetLastError()));
				if (cerr == 87) {
					eprintln( str_intp(2, _MOV((StrIntpData[]){{_SLIT("SymFromAddr failure: "), 0xfe07, {.d_i32 = cerr}}, {_SLIT(" = The parameter is incorrect)"), 0, { .d_c = 0 }}})));
				} else if (cerr == 487) {
					eprintln( str_intp(2, _MOV((StrIntpData[]){{_SLIT("SymFromAddr failure: "), 0xfe07, {.d_i32 = cerr}}, {_SLIT(" = Attempt to access invalid address (Verify that you have the .pdb file in the right folder.)"), 0, { .d_c = 0 }}})));
				} else {
					eprintln( str_intp(2, _MOV((StrIntpData[]){{_SLIT("SymFromAddr failure: "), 0xfe07, {.d_i32 = cerr}}, {_SLIT(" (see https://docs.microsoft.com/en-us/windows/win32/debug/system-error-codes)"), 0, { .d_c = 0 }}})));
				}
			}
		}
		bool _t3 = true;
...
VNORETURN void panic_lasterr(string base) {
	panic_debug(302, tos3("C:/v/vlib/builtin/builtin_windows.c.v"), tos3("builtin"), tos3("panic_lasterr"),  string__plus(base, winapi_lasterr_str()));
	VUNREACHABLE();
	while(1);
}
...
Array_byte Array_byte_clone(Array_byte b) {
	...
	for (int i = 0; i < b.len; ++i) {
		array_set(&res, i, &(byte[]) { (*(byte*)/*ee elem_sym */array_get(b, i)) });
	}
	return res;
}
...
string byte_repeat(byte b, int count) {
	if (count < 0) {
		panic_debug(561, tos3("C:/v/vlib/builtin/int.v"), tos3("builtin"), tos3("repeat"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("byte.repeat: count is negative: "), 0xfe07, {.d_i32 = count}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	} else if (count == 0) {
		return _SLIT("");
	} else if (count == 1) {
...
inline void map_ensure_extra_metas(map* m, u32 probe_count) {
	if ((probe_count << 1U) == m->extra_metas) {
		...
		if (probe_count == 252U) {
			panic_debug(357, tos3("C:/v/vlib/builtin/map.v"), tos3("builtin"), tos3("ensure_extra_metas"),  _SLIT("Probe overflow"));
			VUNREACHABLE();
		}
	}
}
...
string IError_str(IError err) {
	...
	if (err._typ == _IError_None___index) {
		...
		bool old_error_style = ((voidptr)(&(*(err.msg)))) != ((voidptr)(&(*(err.code))));
		_t2 = (old_error_style ? ( str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = charptr_vstring_literal( /* IError */ v_typeof_interface_IError( (err)._typ ))}}, {_SLIT(": "), 0xfe10, {.d_s = (*(err.msg))}}, {_SLIT0, 0, { .d_c = 0 }}}))) : ( str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = charptr_vstring_literal( /* IError */ v_typeof_interface_IError( (err)._typ ))}}, {_SLIT(": "), 0xfe10, {.d_s = IError_name_table[err._typ]._method_msg(err._object)}}, {_SLIT0, 0, { .d_c = 0 }}}))));
	}
	return _t2;
}
...
string rune_repeat(rune c, int count) {
	if (count < 0) {
		panic_debug(46, tos3("C:/v/vlib/builtin/rune.v"), tos3("builtin"), tos3("repeat"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("rune.repeat: count is negative: "), 0xfe07, {.d_i32 = count}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	} else if (count == 0) {
		return _SLIT("");
	} else if (count == 1) {
...
string tos(byte* s, int len) {
	if (s == 0) {
		panic_debug(105, tos3("C:/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos"),  _SLIT("tos(): nil string"));
		VUNREACHABLE();
	}
...
string tos2(byte* s) {
	if (s == 0) {
		panic_debug(122, tos3("C:/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos2"),  _SLIT("tos2: nil string"));
		VUNREACHABLE();
	}
...
string tos3(char* s) {
	if (s == 0) {
		panic_debug(139, tos3("C:/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos3"),  _SLIT("tos3: nil string"));
		VUNREACHABLE();
	}
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_8613322521397010905_RepIndex_by_idx);
	byte* b = malloc_noscan(new_len + 1);
	int idx_pos = 0;
...
bool string__eq(string s, string a) {
	if (s.str == 0) {
		panic_debug(576, tos3("C:/v/vlib/builtin/string.v"), tos3("builtin"), tos3("=="),  _SLIT("string.eq(): nil string"));
		VUNREACHABLE();
	}
	if (s.len != a.len) {
		return false;
...
string string_substr(string s, int start, int end) {
	#if !defined(CUSTOM_DEFINE_no_bounds_checking)
	{
		if (start > end || start > s.len || end > s.len || start < 0 || end < 0) {
			panic_debug(799, tos3("C:/v/vlib/builtin/string.v"), tos3("builtin"), tos3("substr"),   str_intp(4, _MOV((StrIntpData[]){{_SLIT("substr("), 0xfe07, {.d_i32 = start}}, {_SLIT(", "), 0xfe07, {.d_i32 = end}}, {_SLIT(") out of bounds (len="), 0xfe07, {.d_i32 = s.len}}, {_SLIT(")"), 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
byte string_at(string s, int idx) {
	...
	{
		if (idx < 0 || idx >= s.len) {
			panic_debug(1482, tos3("C:/v/vlib/builtin/string.v"), tos3("builtin"), tos3("at"),   str_intp(3, _MOV((StrIntpData[]){{_SLIT("string index out of range: "), 0xfe07, {.d_i32 = idx}}, {_SLIT(" / "), 0xfe07, {.d_i32 = s.len}}, {_SLIT0, 0, { .d_c = 0 }}})));
			VUNREACHABLE();
		}
	}
	#endif
...
string string_repeat(string s, int count) {
	if (count < 0) {
		panic_debug(1765, tos3("C:/v/vlib/builtin/string.v"), tos3("builtin"), tos3("repeat"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("string.repeat: count is negative: "), 0xfe07, {.d_i32 = count}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	} else if (count == 0) {
		return _SLIT("");
	} else if (count == 1) {
...
Option_rune Array_byte_utf8_to_utf32(Array_byte _bytes) {
	...
	if (_bytes.len == 1) {
		Option_rune _t2;
		opt_ok(&(rune[]) { ((rune)((*(byte*)/*ee elem_sym */array_get(_bytes, 0)))) }, (Option*)(&_t2), sizeof(rune));
		return _t2;
	}
	if (_bytes.len > 4) {
	...
	byte b = ((byte)(((int)((*(byte*)/*ee elem_sym */array_get(_bytes, 0))))));
	b = b << _bytes.len;
	rune res = ((rune)(b));
	int shift = 6 - _bytes.len;
	for (int i = 1; i < _bytes.len; i++) {
		rune c = ((rune)((*(byte*)/*ee elem_sym */array_get(_bytes, i))));
		res = ((rune)(res)) << shift;
		res |= (c & 63);
		shift = 6;
	}
...
void golphook__utils__load_unload_console(bool _v_switch, FILE* andFile) {
	if (_v_switch) {
		Beep(670U, 667U);
		AllocConsole();
		freopen_s(&andFile, "CONOUT$", "w", stdout);
		Beep(670U, 667U);
	} else {
		fclose(andFile);
		FreeConsole();
...
int os__fork(void) {
	int pid = -1;
	panic_debug(872, tos3("C:/v/vlib/os/os.c.v"), tos3("os"), tos3("fork"),  _SLIT("os.fork not supported in windows"));
	VUNREACHABLE();
	int _t1 = pid;
	return _t1;
}
...
int os__wait(void) {
	int pid = -1;
	panic_debug(885, tos3("C:/v/vlib/os/os.c.v"), tos3("os"), tos3("wait"),  _SLIT("os.wait not supported in windows"));
	VUNREACHABLE();
	int _t1 = pid;
	return _t1;
}
...
Option_Array_string os__glob(Array_string patterns) {
 ...
 ;
	...
	qsort(matches.data, matches.len, matches.element_size, (int (*)(const void *, const void *))&compare_13753401522076972052_string);
...
os__Result os__execute_or_panic(string cmd) {
	...
	if (res.exit_code != 0) {
		...
		panic_debug(745, tos3("C:/v/vlib/os/os.v"), tos3("os"), tos3("execute_or_panic"),  res.output);
		VUNREACHABLE();
	}
	os__Result _t1 = res;
	return _t1;
...
string os__quoted_path(string path) {
	#if defined(_WIN32)
	{
		string _t1 = (string_ends_with(path, _const_os__path_separator) ? ( str_intp(2, _MOV((StrIntpData[]){{_SLIT("\""), 0xfe10, {.d_s = string__plus(path, _const_os__path_separator)}}, {_SLIT("\""), 0, { .d_c = 0 }}}))) : ( str_intp(2, _MOV((StrIntpData[]){{_SLIT("\""), 0xfe10, {.d_s = path}}, {_SLIT("\""), 0, { .d_c = 0 }}}))));
		return _t1;
	}
	#else
	{
...
Option_string os__get_module_filename(os__HANDLE handle) {
	...
	panic_debug(244, tos3("C:/v/vlib/os/os_windows.c.v"), tos3("os"), tos3("get_module_filename"),  _SLIT("this should be unreachable"));
	VUNREACHABLE();
	return (Option_string){0};
}
...
os__Uname os__uname(void) {
	...
	os__Uname _t1 = (os__Uname){.sysname = string_trim_space((*(string*)/*ee elem_sym */array_get(sys_and_ver, 0))),.nodename = nodename,.release = string_replace((*(string*)/*ee elem_sym */array_get(sys_and_ver, 1)), _SLIT("]"), _SLIT("")),.version = string__plus(string__plus((*(string*)/*ee elem_sym */array_get(sys_and_ver, 0)), _SLIT("[")), (*(string*)/*ee elem_sym */array_get(sys_and_ver, 1))),.machine = machine,};
	return _t1;
}
...
Option_void os__Command_start(os__Command* c) {
	panic_debug(550, tos3("C:/v/vlib/os/os_windows.c.v"), tos3("os"), tos3("start"),  _SLIT("not implemented"));
	VUNREACHABLE();
	return (Option_void){0};
}

string os__Command_read_line(os__Command* c) {
	panic_debug(554, tos3("C:/v/vlib/os/os_windows.c.v"), tos3("os"), tos3("read_line"),  _SLIT("not implemented"));
	VUNREACHABLE();
	return (string){.str=(byteptr)"", .is_lit=1};
}

Option_void os__Command_close(os__Command* c) {
	panic_debug(558, tos3("C:/v/vlib/os/os_windows.c.v"), tos3("os"), tos3("close"),  _SLIT("not implemented"));
	VUNREACHABLE();
	return (Option_void){0};
}
...
void os__Process__check_redirection_call(os__Process* p, string fn_name) {
	if (!p->use_stdio_ctl) {
		panic_debug(180, tos3("C:/v/vlib/os/process.c.v"), tos3("os"), tos3("_check_redirection_call"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("Call p.set_redirect_stdio() before calling p."), 0xfe10, {.d_s = fn_name}}, {_SLIT0, 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
	if (p->status == os__ProcessState__not_started) {
		panic_debug(183, tos3("C:/v/vlib/os/process.c.v"), tos3("os"), tos3("_check_redirection_call"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("Call p."), 0xfe10, {.d_s = fn_name}}, {_SLIT("() after you have called p.run()"), 0, { .d_c = 0 }}})));
		VUNREACHABLE();
	}
}
...
void os__Process_win_write_string(os__Process* p, int idx, string s) {
	panic_debug(174, tos3("C:/v/vlib/os/process_windows.c.v"), tos3("os"), tos3("win_write_string"),   str_intp(2, _MOV((StrIntpData[]){{_SLIT("Process.write_string "), 0xfe07, {.d_i32 = idx}}, {_SLIT(" is not implemented yet"), 0, { .d_c = 0 }}})));
	VUNREACHABLE();
}
...
multi_return_string_int os__Process_win_read_string(os__Process* p, int idx, int maxbytes) {
	...
	{ // Unsafe block
		if (PeekNamedPipe(rhandle, ((voidptr)(0)), ((int)(0)), ((voidptr)(0)), &bytes_avail, ((voidptr)(0))) == false) {
			return (multi_return_string_int){.arg0=_SLIT(""), .arg1=0};
		}
	}
	if (bytes_avail == 0) {
	...
	Array_byte buf = __new_array_with_default(bytes_avail + 300, 0, sizeof(byte), 0);
	ReadFile(rhandle, &(*(byte*)/*ee elem_sym */array_get(buf, 0)), buf.cap, ((voidptr)(&bytes_read)), 0);
	return (multi_return_string_int){.arg0=Array_byte_bytestr(array_slice(buf, 0, bytes_read)), .arg1=bytes_read};
}
...
Option_multi_return_Array_string_int v__vmod__get_array_content(Array_v__vmod__Token tokens, int st_idx) {
	...
	if ((*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, idx)).typ != v__vmod__TokenKind__labr) {
		return (Option_multi_return_Array_string_int){ .state=2, .err=_v_error( str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" not a valid array, at line "), 0xfe07, {.d_i32 = (*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, idx)).line}}, {_SLIT0, 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
	}
	idx++;
	for (;;) {
		...
		if (tok.typ == (v__vmod__TokenKind__str)) {
			...
			if (!((*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, idx + 1)).typ == v__vmod__TokenKind__comma || (*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, idx + 1)).typ == v__vmod__TokenKind__rabr)) {
				return (Option_multi_return_Array_string_int){ .state=2, .err=_v_error( str_intp(4, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" invalid separator \""), 0xfe10, {.d_s = (*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, idx + 1)).val}}, {_SLIT("\", at line "), 0xfe07, {.d_i32 = tok.line}}, {_SLIT0, 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
			}
			...
			return (Option_multi_return_Array_string_int){ .state=2, .err=_v_error( str_intp(4, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" invalid token \""), 0xfe10, {.d_s = tok.val}}, {_SLIT("\", at line "), 0xfe07, {.d_i32 = tok.line}}, {_SLIT0, 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
		};
	}
...
Option_v__vmod__Manifest v__vmod__Parser_parse(v__vmod__Parser* p) {
	if (p->scanner.text.len == 0) {
		return (Option_v__vmod__Manifest){ .state=2, .err=_v_error( str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" no content."), 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
	}
	...
	if ((*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, 0)).typ != v__vmod__TokenKind__module_keyword) {
		return (Option_v__vmod__Manifest){ .state=2, .err=_v_error( str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" v.mod files should start with Module, at line "), 0xfe07, {.d_i32 = (*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, 0)).line}}, {_SLIT0, 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
	}
	int i = 1;
	for (;;) {
		...
		if (tok.typ == (v__vmod__TokenKind__lcbr)) {
			if (!((*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, i + 1)).typ == v__vmod__TokenKind__field_key || (*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, i + 1)).typ == v__vmod__TokenKind__rcbr)) {
				return (Option_v__vmod__Manifest){ .state=2, .err=_v_error( str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" invalid content after opening brace, at line "), 0xfe07, {.d_i32 = tok.line}}, {_SLIT0, 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
			}
			i++;
			continue;
		}
			...
			if (!((*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, i + 1)).typ == v__vmod__TokenKind__str || (*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, i + 1)).typ == v__vmod__TokenKind__labr)) {
				return (Option_v__vmod__Manifest){ .state=2, .err=_v_error( str_intp(4, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" value of field \""), 0xfe10, {.d_s = field_name}}, {_SLIT("\" must be either string or an array of strings, at line "), 0xfe07, {.d_i32 = tok.line}}, {_SLIT0, 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
			}
			...
			if (string__eq(field_name, _SLIT("name"))) {
				...
				if (_t5.state != 0) { /*or block*/
 				...
 				Option_multi_return_Array_string_int mr_4825 =  _t5 /*U*/;
				Array_string deps = (*(multi_return_Array_string_int*)mr_4825.data).arg0;
				int idx = (*(multi_return_Array_string_int*)mr_4825.data).arg1;
				...
				if ((*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, i + 1)).typ == v__vmod__TokenKind__labr) {
					...
					if (_t7.state != 0) { /*or block*/
 					...
 					Option_multi_return_Array_string_int mr_4995 =  _t7 /*U*/;
					Array_string vals = (*(multi_return_Array_string_int*)mr_4995.data).arg0;
					int idx = (*(multi_return_Array_string_int*)mr_4995.data).arg1;
			...
			if (!((*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, i - 1)).typ == v__vmod__TokenKind__str || (*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, i - 1)).typ == v__vmod__TokenKind__rabr) || (*(v__vmod__Token*)/*ee elem_sym */array_get(tokens, i + 1)).typ != v__vmod__TokenKind__field_key) {
				return (Option_v__vmod__Manifest){ .state=2, .err=_v_error( str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" invalid comma placement, at line "), 0xfe07, {.d_i32 = tok.line}}, {_SLIT0, 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
			}
			i++;
			continue;
		}
		else {
			return (Option_v__vmod__Manifest){ .state=2, .err=_v_error( str_intp(4, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = _const_v__vmod__err_label}}, {_SLIT(" invalid token \""), 0xfe10, {.d_s = tok.val}}, {_SLIT("\", at line "), 0xfe07, {.d_i32 = tok.line}}, {_SLIT0, 0, { .d_c = 0 }}}))), .data={EMPTY_STRUCT_INITIALIZATION} };
		};
	}
...
void v__vmod__ModFileCacher_debug(v__vmod__ModFileCacher* mcache) {
	#if defined(_VDEBUG)
	{
		...
		for (int _t2 = 0; _t2 < _t3; ++_t2 ) {
			...
			eprintln( str_intp(4, _MOV((StrIntpData[]){{_SLIT("	 K: "), 0x40fe10, {.d_s = k}}, {_SLIT(" | V: \""), 0x40fe30, {.d_s = v.vmod_file}}, {_SLIT("\" | \""), 0x40fe30, {.d_s = v.vmod_folder}}, {_SLIT("\" "), 0, { .d_c = 0 }}})));
		}
		...
		for (int _t6 = 0; _t6 < _t7; ++_t6 ) {
			...
			eprintln( str_intp(3, _MOV((StrIntpData[]){{_SLIT("	 K: "), 0x40fe10, {.d_s = k}}, {_SLIT(" | V: "), 0xfe10, {.d_s = Array_string_str(v)}}, {_SLIT0, 0, { .d_c = 0 }}})));
		}
	}
	#endif
}
...
void golphook__App_bootstrap(golphook__App* a, voidptr withModuleHandle) {
	...
	Option_v__vmod__Manifest _t1 = v__vmod__decode(_SLIT("Module {\n\011name: 'golphook'\n\011description: 'Cool golp in your game :)'\n\011version: '0.0.1-alpha'\n\011license: 'MIT'\n\011dependencies: []\n}\n"));
	if (_t1.state != 0) { /*or block*/
		IError err = _t1.err;
		panic_debug(24, tos3("C:/Users/fleur/AppData/Local/Temp/golphook/golphook/app.v"), tos3("golphook"), tos3("bootstrap"),  (*(err.msg)));
		VUNREACHABLE();
	;
	}

 	a->v_mod =  (*(v__vmod__Manifest*)_t1.data);
	golphook__utils__load_unload_console(true, a->file);
}
...
voidptr golphook__init_app_singleton(void) {
	golphook__App* s = (golphook__App*)memdup(&(golphook__App){.h_mod = 0,.v_mod = (v__vmod__Manifest){.name = (string){.str=(byteptr)"", .is_lit=1},.version = (string){.str=(byteptr)"", .is_lit=1},.description = (string){.str=(byteptr)"", .is_lit=1},.dependencies = __new_array(0, 0, sizeof(string)),.license = (string){.str=(byteptr)"", .is_lit=1},.repo_url = (string){.str=(byteptr)"", .is_lit=1},.author = (string){.str=(byteptr)"", .is_lit=1},.unknown = new_map(sizeof(string), sizeof(Array_string), &map_hash_string, &map_eq_string, &map_clone_string, &map_free_string),},}, sizeof(golphook__App));
	voidptr _t1 = ((voidptr)(s));
	return _t1;
}

void main__spawn(voidptr h_mod) {
	golphook__App* a = (golphook__App*)memdup(&(golphook__App){.h_mod = 0,.v_mod = (v__vmod__Manifest){.name = (string){.str=(byteptr)"", .is_lit=1},.version = (string){.str=(byteptr)"", .is_lit=1},.description = (string){.str=(byteptr)"", .is_lit=1},.dependencies = __new_array(0, 0, sizeof(string)),.license = (string){.str=(byteptr)"", .is_lit=1},.repo_url = (string){.str=(byteptr)"", .is_lit=1},.author = (string){.str=(byteptr)"", .is_lit=1},.unknown = new_map(sizeof(string), sizeof(Array_string), &map_hash_string, &map_eq_string, &map_clone_string, &map_free_string),},}, sizeof(golphook__App));
	golphook__App_bootstrap(a, h_mod);
}

// Attr: [windows_stdcall]
// Attr: [export]
bool __stdcall main__dll_main(voidptr h_mod, u32 reason, voidptr res) {
	if (reason == ((u32)(DLL_PROCESS_ATTACH))) {
		// go
		thread_arg_main__spawn *arg__t1 = malloc(sizeof(thread_arg_main__spawn));
		arg__t1->arg1 = h_mod;
		HANDLE thread__t1 = CreateThread(0,0, (LPTHREAD_START_ROUTINE)main__spawn_thread_wrapper, arg__t1, 0,0);
		if (!thread__t1) panic_lasterr(tos3("`go main__spawn()`: "));
...
// export alias: DllMain -> main__dll_main
bool __stdcall DllMain(voidptr h_mod, u32 reason, voidptr res) {
	return main__dll_main(h_mod, reason, res);
}
...
void _vinit(int ___argc, voidptr ___argv) {
	...
	{ // Initializations for module golphook.utils :
	}
	...
	{ // Initializations for module golphook :
	}
