	...
	#define V_COMMIT_HASH "1d83ab6"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "0939946"
#endif
...
typedef struct main__Vec2 main__Vec2;
typedef struct main__Angle main__Angle;
typedef struct main__Vec3 main__Vec3;
...
#include <stdbool.h>
#else
#error VERROR_MESSAGE The C compiler can not find <stdbool.h>. Please install build-essentials
#endif
...
VV_LOCAL_SYMBOL int compare_411431903804317452_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
main__Vec3 main__Vec2_vec_3(main__Vec2 v);
main__Vec3* main__Angle_vec_3(main__Angle _v_toheap_a);
main__Vec2* main__Vec3_vec_2(main__Vec3 _v_toheap_v);
main__Vec3 main__Vec3__plus(main__Vec3* l, main__Vec3* r);
main__Vec3 main__Vec3__minus(main__Vec3* l, main__Vec3* r);
main__Vec3 main__Vec3__mult(main__Vec3* l, main__Vec3* r);
main__Vec3 main__Vec3__div(main__Vec3* l, main__Vec3* r);
bool main__Vec3__eq(main__Vec3* l, main__Vec3* r);
bool main__Vec3__lt(main__Vec3* l, main__Vec3* r);
main__Vec3 main__op_vec(f32 withVal);
main__Vec3 main__new_vec3_T_f64(f64 x, f64 y, f64 z);
VV_LOCAL_SYMBOL void main__main(void);
main__Vec3 _v_dump_expr_main__Vec3(string fpath, int line, string sexpr, main__Vec3 dump_arg);

static string main__Vec3_str(main__Vec3 it); // auto
static string indent_main__Vec3_str(main__Vec3 it, int indent_count); // auto
...
struct _IError_interface_methods IError_name_table[3] = {
	{
...
static string main__Vec3_str(main__Vec3 it) { return indent_main__Vec3_str(it, 0);}

// V dump functions:
main__Vec3 _v_dump_expr_main__Vec3(string fpath, int line, string sexpr, main__Vec3 dump_arg) {
	string sline = int_str(line);
	string value = main__Vec3_str(dump_arg);
...
static string indent_main__Vec3_str(main__Vec3 it, int indent_count) {
	string indents = string_repeat(_SLIT("    "), indent_count);
	string res = str_intp( 15, _MOV((StrIntpData[]){
		{_SLIT("Vec3{\n"), 0, {.d_c=0}},
		{_SLIT0, 0xfe10, {.d_s=indents}}, {_SLIT("    x: "), 0, {.d_c=0}}, {_SLIT(""), 0xfe0e, {.d_f32=it.x}}, {_SLIT(""), 0, {.d_c=0}},
		{_SLIT("\n"), 0xfe10, {.d_s=indents}}, {_SLIT("    y: "), 0, {.d_c=0}}, {_SLIT(""), 0xfe0e, {.d_f32=it.y}}, {_SLIT(""), 0, {.d_c=0}},
		{_SLIT("\n"), 0xfe10, {.d_s=indents}}, {_SLIT("    z: "), 0, {.d_c=0}}, {_SLIT(""), 0xfe0e, {.d_f32=it.z}}, {_SLIT(""), 0, {.d_c=0}},
...
int math__bits__trailing_zeros_16(u16 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn32tab, ((u32)((x & -x))) * _const_math__bits__de_bruijn32 >> (27)))));
	return _t2;
}
...
int math__bits__trailing_zeros_32(u32 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn32tab, ((x & -x)) * _const_math__bits__de_bruijn32 >> (27)))));
	return _t2;
}
...
int math__bits__trailing_zeros_64(u64 x) {
	...
	int _t2 = ((int)((*(byte*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn64tab, ((x & -x)) * _const_math__bits__de_bruijn64 >> (58)))));
	return _t2;
}
	...
	{ // Unsafe block
		...
		if (dot_res_sp >= 0) {
			...
			for (int c1 = 1; c1 < dec_digit + 1; ++c1) {
				if (((byte*)res.data)[r_i - c1] == 0) {
					((byte*)res.data)[r_i - c1] = '0';
				}
			}
...
void array_delete_many(array* a, int i, int size) {
	...
	if (ArrayFlags_all(&a->flags, (ArrayFlags__noshrink | ArrayFlags__noslices))) {
		vmemmove(((byte*)(a->data)) + i * a->element_size, ((byte*)(a->data)) + (i + size) * a->element_size, (a->len - i - size) * a->element_size);
		a->len -= size;
		return;
	}
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_411431903804317452_RepIndex_by_idx);
	byte* b = malloc_noscan(new_len + 1);
	int idx_pos = 0;
...
// Attr: [inline]
inline main__Vec3 main__Vec2_vec_3(main__Vec2 v) {
	main__Vec3 _t1 = (main__Vec3){.x = v.x,.y = v.y,.z = 0.0,};
	return _t1;
}

// Attr: [inline]
inline main__Vec3* main__Angle_vec_3(main__Angle _v_toheap_a) {
main__Angle* a = HEAP(main__Angle, _v_toheap_a);
	main__Vec3* _t1 = ((main__Vec3*)(((voidptr)(&(*(a))))));
	return _t1;
}

// Attr: [inline]
inline main__Vec2* main__Vec3_vec_2(main__Vec3 _v_toheap_v) {
main__Vec3* v = HEAP(main__Vec3, _v_toheap_v);
	main__Vec2* _t1 = ((main__Vec2*)(((voidptr)(&(*(v))))));
	return _t1;
}

// Attr: [inline]
inline main__Vec3 main__Vec3__plus(main__Vec3* l, main__Vec3* r) {
	main__Vec3 _t1 = (main__Vec3){.x = l->x + r->x,.y = l->y + r->y,.z = l->z + r->z,};
	return _t1;
}

// Attr: [inline]
inline main__Vec3 main__Vec3__minus(main__Vec3* l, main__Vec3* r) {
	main__Vec3 _t1 = (main__Vec3){.x = l->x - r->x,.y = l->y - r->y,.z = l->z - r->z,};
	return _t1;
}

// Attr: [inline]
inline main__Vec3 main__Vec3__mult(main__Vec3* l, main__Vec3* r) {
	main__Vec3 _t1 = (main__Vec3){.x = l->x * r->x,.y = l->y * r->y,.z = l->z * r->z,};
	return _t1;
}

// Attr: [inline]
inline main__Vec3 main__Vec3__div(main__Vec3* l, main__Vec3* r) {
	main__Vec3 _t1 = (main__Vec3){.x = l->x / r->x,.y = l->y / r->y,.z = l->z / r->z,};
	return _t1;
}

// Attr: [inline]
inline bool main__Vec3__eq(main__Vec3* l, main__Vec3* r) {
	bool _t1 = l->x == r->x && l->y == r->y && l->z == r->z;
	return _t1;
}

// Attr: [inline]
inline bool main__Vec3__lt(main__Vec3* l, main__Vec3* r) {
	bool _t1 = l->x < r->x && l->y < r->y && l->z < r->z;
	return _t1;
}

main__Vec3 main__op_vec(f32 withVal) {
	main__Vec3 _t1 = (main__Vec3){.x = withVal,.y = withVal,.z = withVal,};
	return _t1;
}

main__Vec3 main__new_vec3_T_f64(f64 x, f64 y, f64 z) {
	main__Vec3 _t1 = (main__Vec3){.x = ((f32)(x)),.y = ((f32)(y)),.z = ((f32)(z)),};
	return _t1;
}

VV_LOCAL_SYMBOL void main__main(void) {
	main__Vec3 v = main__new_vec3_T_f64(13.0, 45.3, 244.0);
	 _v_dump_expr_main__Vec3(_SLIT("tests/vec.v"), 92, _SLIT("v"), v );
	main__Vec3 vv = main__op_vec(2);
	 _v_dump_expr_main__Vec3(_SLIT("tests/vec.v"), 94, _SLIT("vv"), vv );
	v = main__Vec3__plus(&v, &vv);
	 _v_dump_expr_main__Vec3(_SLIT("tests/vec.v"), 96, _SLIT("v"), v );
}
